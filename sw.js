const CACHE='triela-pwa-v10';
const SHELL=['/Check-list/','/Check-list/index.html','/Check-list/app.css','/Check-list/app.js','/Check-list/app14.css','/Check-list/app15.css','/Check-list/app16.css','/Check-list/app17.css','/Check-list/app18.css','/Check-list/app19.css','/Check-list/app20.css','/Check-list/app26.js','/Check-list/app30.js','/Check-list/app31.js','/Check-list/app32.js','/Check-list/app33.js','/Check-list/app34.js','/Check-list/triela-mark.svg','/Check-list/pwa-install.js','/Check-list/manifest.webmanifest','/Check-list/icon-192.svg','/Check-list/icon-512.svg','/Check-list/pwa-offline.html'];
