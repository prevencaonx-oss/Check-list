const CACHE='triela-pwa-v6';
const SHELL=['/Check-list/','/Check-list/index.html','/Check-list/app.css','/Check-list/app.js','/Check-list/app14.css','/Check-list/app15.css','/Check-list/app16.css','/Check-list/app17.css','/Check-list/app29.js','/Check-list/app30.js','/Check-list/app31.js','/Check-list/pwa-install.js','/Check-list/manifest.webmanifest','/Check-list/icon-192.svg','/Check-list/icon-512.svg','/Check-list/pwa-offline.html'];
